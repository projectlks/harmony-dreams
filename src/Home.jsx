...
function App() {
  ...
  return (
    <section>
      ...
      <section
        id="home"
        className="w-full scroll-smooth flex bg-[url('./assets/img/phone.png')] h-screen xl:bg-[url('./assets/img/Computerbg.png')] xl:bg-cover xl:bg-[#D9D9D9] bg-backgroundImage bg-center bg-cover bg-fixed bg-no-repeat relative transition-all overflow-hidden mx-auto min-h-screen"
      >

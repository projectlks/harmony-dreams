  ...
  return (
    <section>
      ...
      <footer className="bg-[#D9D9D9] text-[#737373] w-full py-5">
        ...
        <div className="relative  border flex justify-between  h-[100px] px-10 w-[80%] mx-auto mb-10 rounded-md border-[#737373]">
          {/* text */}
          <div className="absolute -top-5 flex justify-center left-0 right-0">
            <p className=" px-4 py-2 text-center bg-[#D9D9D9] inline-block">
          ...
          <div className="flex items-center space-x-3 px-4">
            ...
            <span>
              ...
              <p className="text-sm">09 975 478 222</p>
              <p className="text-sm">09 692 774 290</p>
            </span>
          </div>

          {/* viber */}
          <div className="flex items-center space-x-3 px-4">
            <i class="fa-brands fa-viber text-5xl"></i>
            <span>
              <h1 className="text-xl font-bold">Viber</h1>
              <a className="block" href={`viber://contact?number=09975478222`}>
                09 975 478 222
              </a>
              <a className="block" href={`viber://contact?number=096927742902`}>
                09 692 774 290
              </a>
            </span>
          </div>
          ...
          <div className="flex items-center space-x-3 px-4">
            ...
            <span>
              ...
              <p className="text-sm">harmonydreams13@gmail.com</p>
            </span>
          </div>
        </div>
      </footer>
